...
// ---------- MQTT ----------
const char* mqtt_server = "11.56.49.33"; // Change to your MQTT broker IP
const int mqtt_port = 1883;

const char* TOPIC_TEMP = "home/sub/temp"; 
const char* TOPIC_HUM  = "home/sub/hum";// Topic for temperature
